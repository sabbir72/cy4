...
describe('Login and Style Test with Print to back', () => {
  it('Handles login Style Print to back', () => {
   ...
   cy.get('input[data-fieldname="name"]').clear().type('style_72_1750823588600-1');
     ...
     cy.get('a[data-name="style_72_1750823588600-1"]').click()
     cy.wait(1000)
     cy.get('button[data-original-title="Print"]').eq(0).click()
     cy.wait(5000)
     cy.get('button[data-original-title="Form"]').click()
